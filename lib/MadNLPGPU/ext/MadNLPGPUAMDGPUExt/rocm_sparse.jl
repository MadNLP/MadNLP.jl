######################################################
##### ROCm wrappers for SparseCondensedKKTSystem #####
######################################################
...
#=
    MadNLP.mul! with SparseCondensedKKTSystem + ROCm
=#
...
function MadNLP._build_scale_augmented_system_coo!(dest, src, scaling::ROCArray, n, m)
    backend = ROCBackend()
