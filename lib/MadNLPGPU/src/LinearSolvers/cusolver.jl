...
for (syevd, syevd_buffer, gemm, nbytes, T) in
    ((:cusolverDnDsyevd, :cusolverDnDsyevd_bufferSize, :cublasDgemm_v2_64, :8, :Float64),
     (:cusolverDnSsyevd, :cusolverDnSsyevd_bufferSize, :cublasSgemm_v2_64, :4, :Float32))
    @eval begin
