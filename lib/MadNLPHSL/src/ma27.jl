...
# @kwdef mutable struct Ma27Ma27Options <: AbstractMa27Options
#     ma27_pivtol::Float64 = 1e-8
#     ma27_pivtolmax::Float64 = 1e-4
#     ma27_liw_init_factor::Float64 = 5.
#     ma27_la_init_factor::Float64 =5.
...
# mutable struct Ma27Ma27Solver{T} <: AbstractLinearMa27Solver{T}
#     csc::SparseMatrixCSC{T,Int32}
#     I::Vector{Int32}
#     J::Vector{Int32}
...
# function Ma27Ma27Solver(csc::SparseMatrixCSC{T};
#                 option_dict::Dict{Symbol,Any}=Dict{Symbol,Any}(),
#                 opt=Ma27Ma27Options(),logger=Logger(),kwargs...) where T
...
#     return Ma27Ma27Solver{T}(csc,I,J,icntl,cntl,info,a,a_view,la,ikeep,iw,liw,
#                   iw1,nsteps,Vector{T}(),maxfrt,opt,logger)
# end


# function factorize!(M::Ma27Ma27Solver)
#     M.a_view.=M.csc.nzval
#     while true
#         ma27b!(Int32(M.csc.n),Int32(nnz(M.csc)),M.I,M.J,M.a,M.la,
#                 M.iw,M.liw,M.ikeep,M.nsteps,M.maxfrt,
...
# function solve!(M::Ma27Ma27Solver{T},rhs::Vector{T}) where T
#     length(M.w)<M.maxfrt[1] && resize!(M.w,M.maxfrt[1])
#     length(M.iw1)<M.nsteps[1] && resize!(M.iw1,M.nsteps[1])
#     ma27c!(Int32(M.csc.n),M.a,M.la,M.iw,M.liw,M.w,M.maxfrt,rhs,
#             M.iw1,M.nsteps,M.icntl,M.info)
...
# is_inertia(::Ma27Ma27Solver) = true
# function inertia(M::Ma27Ma27Solver)
#     rank = M.info[1]==3 ? M.info[2] : rank = M.csc.n
#     return (rank-M.info[15],M.csc.n-rank,M.info[15])
# end

# function improve!(M::Ma27Ma27Solver)
#     if M.cntl[1] == M.opt.ma27_pivtolmax
#         @debug(M.logger,"improve quality failed.")
#         return false
#     end
...
# introduce(::Ma27Ma27Solver)="ma27"
# input_type(::Type{Ma27Ma27Solver}) = :csc
