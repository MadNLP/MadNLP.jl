@kwdef mutable struct UmfpackOptions <: AbstractOptions
    umfpack_pivtol::Float64 = 1.0e-4
    umfpack_pivtolmax::Float64 = 1.0e-1
    umfpack_sym_pivtol::Float64 = 1.0e-3
    umfpack_block_size::Float64 = 16
    umfpack_strategy::Float64 = 2.0
end
...
function improve!(M::UmfpackSolver)
    ...
    M.inner.control[4] = min(M.opt.umfpack_pivtolmax, M.inner.control[4]^0.75)
